...
import { DealZoomComponent } from './deal-zoom/deal-zoom.component';
...
export class DealComponent implements OnInit {
  ...
  public openZoomViewer() {
    this.dialog.open(DealZoomComponent, {
      data: this.zoomImage,
  ...
  public purchase(deal: Deal, option: OptionPrice){ 
    //let currentUser = this.userTdoService.currentUserValue; 
    ...
    this.dataPaService.updateDeal(deal); 
    this.dataPaService.updateOption(option); 
