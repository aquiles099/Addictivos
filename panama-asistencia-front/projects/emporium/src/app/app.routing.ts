...
export const routes: Routes = [
    { 
        ...
        component: PagesComponent, children: [
            ...
            { path: 'deals', loadChildren: './pages/deals-details/deals-details.module#DealsDetailsModule', data: { breadcrumb: 'Ofertas'} },
            { path: 'promos', loadChildren: './pages/promo-details/promo-details.module#PromoDetailsModule', data: { breadcrumb: 'Promociones'} }
        ]
    },
