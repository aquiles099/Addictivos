...
return [
    ...
    */
    ...
    'attributes' => [
        'short_title' => 'Titulo corto',
        'long_title' => 'Titulo largo',
        'deal_total_limit' => 'Limite de la oferta',
        'user_purchase_limit' => 'Limite de compra por usuario',
        'short_description' => 'Descripcion corta',
        'long_description' => 'Descripcion larga',
        'restrictions' => 'Restricciones',
        'commerce_id' => 'Comercio',
        'effective_date' => 'Fecha de validez',
        'category' => 'Categoria',
        'closing_date' => 'Fecha de finalización',
        'is_public' => 'Publico',
        'available_until' => 'Válido hasta',
        'gift_title' => 'Titulo de regalo',
        'user_gift_limit' => 'Limite de regalos por usuario',
        'discount' => 'Descuento',
        'images_deal' => 'Galeria',
        'payment_type' => 'Tipo de pago',
        'deal_type_id' => 'Tipo de oferta',
        'commission' => 'Comisión',
        'company_id' => 'Compañia',
        'name' => 'Nombre',
        'last_name' => 'Apellido',
